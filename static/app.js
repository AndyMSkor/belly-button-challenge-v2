...
function buildingTheCharts(sample) {
    ...
    d3.json(testing_data).then(function(data) {
        ...
        let moduleSamples = data.samples
        //console.log(moduleSamples)

        let sampArray = moduleSamples.filter(sampleObject => sampleObject.id == sample);
        ...
        let samplesData = sampResult.sample_values;
